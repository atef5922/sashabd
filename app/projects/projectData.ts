...
export const projects: readonly Project[] = [
  {
    ...
    imageAlt: "P5 outdoor LED billboard project in Nasirabad, Chattogram",
  ...
  },
  {
    ...
    image: "/images/conference_system_projects/conference_p1.webp",
    imageAlt: "Corporate boardroom conference system installation in Dhaka by Sasha Corporation",
    imagePosition: "center",
    organization: "Confidential Corporate Client",
    location: "Gulshan, Dhaka, Bangladesh",
    year: "2026",
    completed: "August 2026",
    completedIso: "2026-08-01",
    capacity: "18–20 Participants",
    systemType: "Digital Wired Conference System with Hybrid Video Conferencing",
    subtitle: "Gulshan, Dhaka • August 2026",
    ...
    seo: {
      title: "Corporate Boardroom Conference System Installation in Dhaka | Sasha Corporation",
      description: "Explore Sasha Corporation's corporate boardroom conference system installation in Dhaka featuring digital discussion microphones, 4K PTZ video conferencing, professional audio and complete AV integration.",
    },
    detail: {
      projectName: "Executive Boardroom Digital Conference & Video Collaboration System",
      h1: "Corporate Boardroom Conference System Installation in Dhaka",
      projectType: "Corporate Boardroom AV & Conference System Integration",
      overview: [
        "Sasha Corporation delivered a complete digital conference and video collaboration solution for a modern corporate boardroom in Gulshan, Dhaka.",
      ...
      systemDetails: [
        { label: "Client", value: "Confidential Corporate Client" },
  ...
  },
  {
    ...
    detail: {
      ...
      overview: [
        "Sasha Corporation delivered a complete smart executive meeting room and hybrid video conference solution in Banani, Dhaka, designed for approximately 10–12 participants.",
  ...
  },
  {
    ...
    detail: {
      ...
      overview: [
        "Sasha Corporation delivered a professional digital conference and discussion system for a large institutional meeting room in Agargaon, Dhaka.",
      ...
      systemDetails: [
        { label: "Client", value: "Confidential Institutional Client" },
