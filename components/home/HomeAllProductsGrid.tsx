            ...
            >
              ...
              <div className="relative">
                <button
                  ...
                  className="absolute -left-1 top-[28%] z-20 inline-flex -translate-y-1/2 items-center justify-center p-0 text-[#F56605] transition active:scale-95"
                  aria-label={`Previous ${section.title} products`}
                >
                  <svg viewBox="0 0 24 24" className="h-5 w-5 drop-shadow-[0_2px_4px_rgba(255,255,255,0.55)]" fill="none" aria-hidden="true">
                ...
                <button
                  type="button"
                  onClick={() => scrollMobileCarousel(section.id, 1)}
                  className="absolute -right-1 top-[28%] z-20 inline-flex -translate-y-1/2 items-center justify-center p-0 text-[#F56605] transition active:scale-95"
