        ...
        <div className="flex flex-col gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-sm md:flex-row md:items-center md:justify-between">
          ...
          {showBackLink ? (
            <button
              ...
              className="inline-flex w-fit cursor-pointer items-center justify-center self-start rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-900 transition hover:border-slate-300 hover:text-slate-950 md:self-auto"
            >
