...
export default function RentalProductsPage() {
  ...
  // ✅ Add one more rental product card locally (no change to productsCatalog needed)
  ...
  // ✅ only push extra if slug not already present
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 pb-8 pt-0 md:px-6">
      ...
      {/* Booking planner */}
      <Section
        title="🗂️ Rental LED Event Booking Planner"
