...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: socialImageUrl("/assets/led-display/outdoor/P5-Outdoor-LED-Display.webp"), width: 1200, height: 630, alt: "Outdoor LED Display Price in Bangladesh" }],
  },
  twitter: {
    ...
    images: [socialImageUrl("/assets/led-display/outdoor/P5-Outdoor-LED-Display.webp")],
  },
};
...
function OutdoorHero() {
  return <section className="led-display-hero-shell relative left-1/2 right-1/2 isolate -mx-[50vw] -mt-2 min-h-[430px] w-screen overflow-hidden bg-[#f7f9fc] sm:min-h-[420px] lg:min-h-[clamp(20rem,25vw,23rem)]" aria-labelledby="outdoor-led-hero-heading">
    <Image src="/assets/led-display/heroes/outdoor-led-hero.webp" alt="Outdoor LED billboard with weather-ready cabinets and display modules" fill priority quality={95} sizes="100vw" className="object-cover object-[70%_center] md:object-center" />
