...
export default async function ControllerDetailsPage(
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-8 md:px-6">
      ...
      {/* Featured Products */}
      <section className="mt-8 rounded-3xl border bg-white p-6 md:p-10" style={{ borderColor: `${BRAND.maroon}12` }}>
        <h2 className="hidden text-2xl font-bold text-slate-900 md:block">Featured Controllers</h2>
        ...
        <div className="mt-5">
          <MobileFeaturedProductsRail
            viewAllHref="/led-display/accessories/controller/"
            items={featuredProducts.map((fp) => ({
              ...
              imageSrc: fp.image,
              imageAlt: fp.title,
              imageClassName: "h-full w-full object-contain p-2 transition duration-300",
