...
export const accessoryPages: Record<AccessoryCategory, AccessoryPageContent> = {
  "receiving-card": {
    ...
    image: { src: "/images/receiving-card/R-732-Receiving-Card.webp", width: 1024, height: 683, alt: "R-732 LED display receiving card with HUB connectors", caption: "R-732 receiving card · Catalog example" },
  ...
  controller: {
    ...
    image: { src: "/images/controller/Huidu-HD-VP620-LED-Video-Processor.webp", width: 905, height: 488, alt: "Huidu HD VP620 LED video processor front and rear connections", caption: "Huidu HD VP620 · Front & rear view" },
  ...
  "power-supply": {
    ...
    image: { src: "/images/power-supply/G-Energy-5V-40A-LED-Display-Power-Supply.webp", width: 1000, height: 655, alt: "G-Energy 5V 40A LED cabinet power supply", caption: "G-Energy 5V 40A · Catalog example" },
  ...
  "led-accessories": {
    ...
    image: { src: "/images/accessories/led-accessories-common.webp", width: 1353, height: 1163, alt: "LED power cable, ribbon cable, connector and module-fixing magnets", caption: "Cables, connectors & fixing hardware · Category overview" },
