...
export default function ReceivingCardSpecTabs({
  specs,
  description,
  brandMaroon,
}: {
      ...
      <div className="border-b border-slate-200 pb-3">
        <div className="flex items-center gap-6 text-base font-semibold">
          <button
            ...
            style={{ borderColor: activeTab === "spec" ? brandMaroon : "transparent", color: activeTab === "spec" ? brandMaroon : "#334155" }}
          >
            Specifications
          </button>
          <button
            ...
            className="border-b-2 pb-2"
            style={{ borderColor: activeTab === "description" ? brandMaroon : "transparent", color: activeTab === "description" ? brandMaroon : "#475569" }}
          >
            Description
          </button>
        </div>
